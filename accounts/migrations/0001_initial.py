# Generated by Django 5.2.6 on 2025-09-17 16:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_id', models.CharField(default=uuid.uuid4, max_length=20, unique=True)),
        ...
        migrations.AddField(
            model_name='invoice',
            name='job',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='invoice', to='accounts.job'),
        ),
        migrations.CreateModel(
            name='Expense',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('credit_card', 'Credit Card'), ('bank_transfer', 'Bank Transfer'), ('check', 'Check'), ('cash', 'Cash'), ('digital_wallet', 'Digital Wallet')], max_length=20)),
